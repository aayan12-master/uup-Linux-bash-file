#!/bin/bash
#Generated on 2021-11-17 08:59:47 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=f8274f9a-6a7b-47f3-bc0e-6a8a10533c04&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
